...
let%expect_test "the debug course, so tuning diffs are visible" =
  ...
  [%expect
    ...
    (((x 900) (gap_center 240))
     ...
     ((x 2954.7593389959115) (gap_center 190.78416802454524))
     ((x 3593.2818519008515) (gap_center 301.36101715263908))
     ((x 4211.6441448595124) (gap_center 224.77272972488979)))
    (course.finish_x 21103.9843688057)
    |}]
;;
